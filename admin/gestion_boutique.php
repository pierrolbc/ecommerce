...
if(isset($_GET['action']) && $_GET['action'] == "affichage")
{
    ...
    $contenu .= '<table border="2" style= " background-image: linear-gradient(to right top, #f314fd, #cd00fa, #a400f6, #7305f1, #1b12eb);"><tr>';
  ...
  while($ligne = $resultat->fetch_assoc())
    ...
    $contenu .= '<td><a href="?action=modification&id_produit='.$ligne['id_produit'] .'"><img src="../inc/img/edit-button.png"></a></td>';
